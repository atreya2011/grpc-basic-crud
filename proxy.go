...
var basiccrudEndpoint = flag.String("endpoint", "localhost:6000", "endpoint of BasicCrudService")
...
func run() error {
	...
	err := basiccrud.RegisterBasicCrudHandlerFromEndpoint(ctx, mux, *basiccrudEndpoint, opts)
	if err != nil {
		log.Fatalln(err)
	}
